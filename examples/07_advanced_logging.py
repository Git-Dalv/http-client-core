...
def example_5_production_setup():
    ...
    from src.http_client.core.config import TimeoutConfig, SecurityConfig
    ...
    config = HTTPClientConfig.create(
        base_url="https://httpbin.org",
        timeout=TimeoutConfig.create(connect=5.0, read=10.0, total=30.0),
        retry=RetryConfig.create(max_attempts=3, backoff_factor=2.0),
        security=SecurityConfig.create(
            verify_ssl=True,
